...
const createPagination = (fetchFn, keyword = '') => {
  ...
  const renderPagination = (totalPage) => {
    ...
    prevBtn.innerHTML = '<svg class="icon icon-arrow-left" width="16" height="16"><use href="./src/img/svg/symbol-defs.svg#icon-arrow-left"></use></svg>';
    ...
    nextBtn.innerHTML = '<svg class="icon icon-arrow-left" width="16" height="16"><use href="./src/img/svg/symbol-defs.svg#icon-arrow-right"></use></svg>';
